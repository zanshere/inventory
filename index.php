  ...
  <section id="features" class="py-20 bg-gray-800">
    <div class="max-w-7xl mx-auto text-center px-6">
      ...
      <p class="text-lg text-gray-300 mb-12">
        Our platform is packed with powerful features to help you manage your inventory effortlessly. Discover what makes our solution stand out.
      </p>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-gray-700 p-8 rounded-lg shadow-lg hover:bg-gray-600 transition-colors">
          ...
          <p class="text-gray-300">
            Easily manage your inventory, track stock levels, and update product details with an intuitive interface.
          </p>
        </div>
        <!-- Feature Card 2 -->
        <div class="bg-gray-700 p-8 rounded-lg shadow-lg hover:bg-gray-600 transition-colors">
  ...
  <section id="signup" class="py-20 bg-gray-900">
    <div class="max-w-4xl mx-auto text-center px-6">
      ...
      <p class="text-lg text-gray-300 mb-8">
        Experience a seamless, efficient, and secure way to manage your business inventory. Unlock a suite of powerful features designed to streamline your operations and drive growth.
      </p>
      <div class="flex flex-col sm:flex-row justify-center gap-4 mb-8">
        <a href="auth/register.php" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg text-lg font-semibold transition-colors">
          Sign Up
        </a>
        <a href="auth/login.php" class="bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-lg text-lg font-semibold transition-colors">
          Sign In
        </a>
      </div>
...
<section id="contact" class="py-20 bg-gray-800 dark:bg-gray-800">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-400 dark:text-gray-300 max-w-2xl mx-auto">Have a project in mind or want to collaborate? 
        ...
        <div class="grid lg:grid-cols-2 gap-12 bg-dark dark:bg-gray-900 rounded-2xl p-8 shadow-lg">
            ...
            <div class="space-y-8">
                <div>
                    ...
                    <div class="flex items-start space-x-4 mb-6">
                        <div class="bg-gray-700 p-3 rounded-lg">
                            <svg class="w-6 h-6 text-white-600 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <a href="mailto:reventory@gmail.com" class="text-blue-600 dark:text-blue-400 hover:underline">
                ...
                <div class="pt-8 border-t border-gray-200 dark:border-gray-700">
                  <h3 class="text-xl font-semibold text-white-800 dark:text-white mb-6">Follow Retail Inventory</h3>
                  ...
                  <!-- GitHub -->
                  <a href="#" class="text-gray-600 hover:text-white dark:text-gray-300 dark:hover:text-white transition-colors">
